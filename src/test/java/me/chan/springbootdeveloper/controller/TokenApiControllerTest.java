...
import me.chan.springbootdeveloper.config.jwt.JwtFactory;
import me.chan.springbootdeveloper.config.jwt.JwtProperties;
...
class TokenApiControllerTest {
    ...
    @DisplayName("createdNewAccessToken:새로운 액세스 토큰을 발급힌다. ")
    @Test
